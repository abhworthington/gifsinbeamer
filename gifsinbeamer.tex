...
\begin{frame}
	\begin{center}
	\animategraphics[width=.75\linewidth]{25}{figures/jack/jack-}{0}{82} %this command is: \animategraphics[options]{frames per second}{root of filename}{first frame number}{last frame number} - I knew to use 33.33 fps because I cheated and looked at the GIF properties (30ms per frame) in GIMP. You may choose to eyeball this. This all comes up again in the slides later on down there. Also, I stuck my gif frames in folders for safekeeping, hence the filename structure. The file name was "jack-0.png", for instance.
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
	\animategraphics[width=\linewidth]{18}{figures/cat/cat-}{0}{49}
	\end{center}
	\end{frame}
...
\begin{frame}
	...
	Sizing works the same as the ``graphics'' commands, but framerate may be new to you. Here's a gif at ``proper'' speed - 10 fps.
		\begin{center}
		\animategraphics[width=\linewidth]{10}{figures/steve/steve-}{0}{26}
		\end{center}
\end{frame}
...
\begin{frame}
	...
	Here's the same gif at double speed - 20 fps.
		\begin{center}
		\animategraphics[width=\linewidth]{20}{figures/steve/steve-}{0}{26}
		\end{center}
	Have fun with this.
\end{frame}
...
\begin{frame}
	...
	\begin{center}
	\animategraphics[width=\linewidth]{20}{figures/comp/comp-}{0}{223}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
	\animategraphics[width=\linewidth]{12.5}{figures/lakerbros/lakerbros-}{0}{42}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
	\animategraphics[width=\linewidth]{12.5}{figures/lakerbros/lakerbros-}{42}{0}
	\end{center}
	\pause
